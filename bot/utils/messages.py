...
# Сообщения для команды /hero_today
...
# Сообщения для команды /become_hero
...
# Сообщения для команды /hero_top
...
# Сообщения для команды /create_event
CREATE_EVENT_NOT_ADMIN_MESSAGE = "❌ Эта команда доступна только администратору."
...
# --- Модуль events_list ---
# Сообщения для команды /events_list
EVENTS_LIST_HEADER = (
    "📅 Список предстоящих событий (страница {page} из {total_pages}):\n\n"
)
EVENTS_LIST_NO_EVENTS_MESSAGE = "❌ Нет предстоящих событий."
...
# --- Модуль delete_event ---
# Сообщения для команды /delete_event
...
# Сообщения для задачи hero_notification
...
# Сообщения для задачи birthday_notification
...
# Сообщения для задачи bartender_notification
